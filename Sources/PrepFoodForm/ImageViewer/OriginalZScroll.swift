...
class OriginalCenteringScrollView: UIScrollView {
  func centerContent() {
...
struct OriginalZScroll<Content: View>: View {
  let content: Content
  ...
  var body: some View {
    OriginalZScrollImpl(content: content, doubleTap: doubleTap.eraseToAnyPublisher())
...
fileprivate struct OriginalZScrollImpl<Content: View>: UIViewControllerRepresentable {
  let content: Content
  ...
  class ViewController: UIViewController, UIScrollViewDelegate {
    ...
    let scrollView = OriginalCenteringScrollView()
